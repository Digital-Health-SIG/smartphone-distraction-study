...
\vfill
\begin{center}
    \qrcode[height=5cm]{https://drive.google.com/file/d/1Mtckvi0GppKgYUsrqOpDYGfOkUgTNhoA/view?usp=sharing}
\end{center}
\vfill
\newpage
...
\end{center}
\sidenote{Heho}Bitte \say{Ja} auswählen, dann taucht eine Liste der installierten Apps auf. Hier soll dann entsprechend die \say{Lernstudie} ausgewählt werden:
\begin{center}
